...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    /* O construtor do Renderer LANÇA quando o navegador recusa um contexto
       WebGL — o que acontece depois de muitas criações seguidas (Fast Refresh)
       ou em máquinas sem aceleração. Sem este try o erro sobe pela árvore do
       React e derruba a seção inteira por causa de um fundo decorativo. */
    let renderer;
    try {
      ...
      console.warn('Lightfall: contexto WebGL indisponível; seguindo sem o fundo animado.', err);
      return;
    }
    ...
    /* Se o contexto cair (troca de GPU, aba dormindo demais, limite de
       contextos do navegador), paramos o loop em vez de tentar desenhar num
       contexto morto a cada quadro e inundar o console. */
