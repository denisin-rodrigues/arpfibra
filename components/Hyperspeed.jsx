...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      onWindowResize() {
        ...
        // Com o loop parado (reduced motion) é preciso redesenhar à mão.
      ...
      tick() {
        ...
        if (this.hasValidSize) {
          ...
          // Quadro único: a estrada aparece parada, sem movimento nenhum.
          if (this.reducedMotion) return;
        }
  ...
  return <div id="lights" ref={hyperspeed} aria-hidden="true"></div>;
};
